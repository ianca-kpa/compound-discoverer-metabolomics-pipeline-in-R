...
output_dir <- "output/251114_HM_OP_untargeted_POS_SEP"
...
duplicate_name_strategy <- "keep_separate"
...
make_sig_heatmap_by_model <- TRUE             # options: TRUE/FALSE (if TRUE, additional heatmaps will be generated showing only the significant features for each comparison)
make_sig_heatmap_by_model_sex <- TRUE        # options: TRUE/FALSE (if TRUE, additional heatmaps will be generated showing only the significant features for each comparison)
make_sig_heatmap_FvsM_within_group <- TRUE    # options: TRUE/FALSE (if TRUE, additional heatmaps will be generated showing only the significant features for the comparison)
...
# -------------------------
volcano_classic_point_size <- 3              # options: numeric > 0
